...
-- CreateEnum
CREATE TYPE "TipoAbastecimentoSolicitacao" AS ENUM ('COM_COTA', 'LIVRE', 'COM_AUTORIZACAO');

-- CreateEnum
CREATE TYPE "StatusSolicitacao" AS ENUM ('PENDENTE', 'APROVADA', 'REJEITADA', 'EXPIRADA', 'EFETIVADA', 'CANCELADA');

-- CreateEnum
CREATE TYPE "StatusSolicitacaoQrCodeVeiculo" AS ENUM ('Solicitado', 'Aprovado', 'Em Produção', 'Integração', 'Concluída', 'Inativo', 'Cancelado');
...
-- CreateIndex
CREATE UNIQUE INDEX "solicitacoes_qrcode_veiculo_codigo_qrcode_key" ON "solicitacoes_qrcode_veiculo"("codigo_qrcode");

-- CreateIndex
CREATE UNIQUE INDEX "qrcode_motorista_codigo_qrcode_key" ON "qrcode_motorista"("codigo_qrcode");

...
@ApiTags('QR Code Motorista')
@Controller('qrcode-motorista')
@UseGuards(JwtAuthGuard)
@ApiBearerAuth()
export class QrCodeMotoristaController {
  constructor(private readonly qrCodeMotoristaService: QrCodeMotoristaService) {}
  ...
  async findAllGroupedByPrefeitura(@Query() filterDto: FilterSolicitacoesDto) {
    try {
      return await this.qrCodeMotoristaService.findAllGroupedByPrefeitura(filterDto);
    } catch (error) {
  ...
  async findOne(@Param('id', ParseIntPipe) id: number) {
    try {
      return await this.qrCodeMotoristaService.findOne(id);
    } catch (error) {
  ...
  async updateStatusToAprovado(
    ...
    try {
      const updateDto: UpdateStatusDto = { status: StatusQrCodeMotorista.Aprovado };
      return await this.qrCodeMotoristaService.updateStatus(id, updateDto, req.user?.id);
    } catch (error) {
      if (error instanceof BadRequestException || error instanceof NotFoundException) {
        throw error;
      }
  ...
  async updateStatusToEmProducao(
    ...
    try {
      const updateDto: UpdateStatusDto = { status: StatusQrCodeMotorista.Em_Producao };
      return await this.qrCodeMotoristaService.updateStatus(id, updateDto, req.user?.id);
    } catch (error) {
      if (error instanceof BadRequestException || error instanceof NotFoundException) {
        throw error;
  ...
  async updateStatusToIntegracao(
    ...
    try {
      const updateDto: UpdateStatusDto = { status: StatusQrCodeMotorista.Integracao };
      return await this.qrCodeMotoristaService.updateStatus(id, updateDto, req.user?.id);
    } catch (error) {
      if (error instanceof BadRequestException || error instanceof NotFoundException) {
        throw error;
  ...
  async updateStatusToConcluida(
    ...
    try {
      const updateDto: UpdateStatusDto = { status: StatusQrCodeMotorista.Concluida };
      return await this.qrCodeMotoristaService.updateStatus(id, updateDto, req.user?.id);
    } catch (error) {
      if (error instanceof BadRequestException || error instanceof NotFoundException) {
        throw error;
  ...
  async updateStatusToCancelado(
    ...
    try {
      ...
      return await this.qrCodeMotoristaService.updateStatus(id, updateStatusDto, req.user?.id);
    } catch (error) {
      if (error instanceof BadRequestException || error instanceof NotFoundException) {
        throw error;
      }
  ...
  async updateStatusToInativo(
    ...
    try {
      const updateDto: UpdateStatusDto = { status: StatusQrCodeMotorista.Inativo };
      return await this.qrCodeMotoristaService.updateStatus(id, updateDto, req.user?.id);
    } catch (error) {
      if (error instanceof BadRequestException || error instanceof NotFoundException) {
        throw error;
